...
use bytes::Bytes;
use trill_api::AuthProvider;
use trill_api::ChatClient;
use trill_api::Provider;
use trill_api::ResponsesClient;
use trill_api::ResponsesOptions;
use trill_api::WireApi;
use trill_api::requests::responses::Compression;
use trill_client::HttpTransport;
use trill_client::Request;
use trill_client::Response;
use trill_client::StreamResponse;
use trill_client::TransportError;
...
fn provider(name: &str, wire: WireApi) -> Provider {
    Provider {
        ...
        wire,
        headers: HeaderMap::new(),
        retry: trill_api::provider::RetryConfig {
            max_attempts: 1,
