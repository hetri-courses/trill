...
use chrono::Utc;
use trill_app_server_protocol::Account;
use trill_app_server_protocol::AccountLoginCompletedNotification;
use trill_app_server_protocol::AccountUpdatedNotification;
use trill_app_server_protocol::AddConversationListenerParams;
use trill_app_server_protocol::AddConversationSubscriptionResponse;
use trill_app_server_protocol::AppsListParams;
use trill_app_server_protocol::AppsListResponse;
use trill_app_server_protocol::ArchiveConversationParams;
use trill_app_server_protocol::ArchiveConversationResponse;
use trill_app_server_protocol::AskForApproval;
use trill_app_server_protocol::AuthMode;
use trill_app_server_protocol::AuthStatusChangeNotification;
use trill_app_server_protocol::CancelLoginAccountParams;
use trill_app_server_protocol::CancelLoginAccountResponse;
use trill_app_server_protocol::CancelLoginAccountStatus;
use trill_app_server_protocol::CancelLoginChatGptResponse;
use trill_app_server_protocol::ClientRequest;
use trill_app_server_protocol::CollaborationModeListParams;
use trill_app_server_protocol::CollaborationModeListResponse;
use trill_app_server_protocol::CommandExecParams;
use trill_app_server_protocol::ConversationGitInfo;
use trill_app_server_protocol::ConversationSummary;
use trill_app_server_protocol::DynamicToolSpec as ApiDynamicToolSpec;
use trill_app_server_protocol::ExecOneOffCommandResponse;
use trill_app_server_protocol::FeedbackUploadParams;
use trill_app_server_protocol::FeedbackUploadResponse;
use trill_app_server_protocol::ForkConversationParams;
use trill_app_server_protocol::ForkConversationResponse;
use trill_app_server_protocol::FuzzyFileSearchParams;
use trill_app_server_protocol::FuzzyFileSearchResponse;
use trill_app_server_protocol::GetAccountParams;
use trill_app_server_protocol::GetAccountRateLimitsResponse;
use trill_app_server_protocol::GetAccountResponse;
use trill_app_server_protocol::GetAuthStatusParams;
use trill_app_server_protocol::GetAuthStatusResponse;
use trill_app_server_protocol::GetConversationSummaryParams;
use trill_app_server_protocol::GetConversationSummaryResponse;
use trill_app_server_protocol::GetUserAgentResponse;
use trill_app_server_protocol::GetUserSavedConfigResponse;
use trill_app_server_protocol::GitDiffToRemoteResponse;
use trill_app_server_protocol::GitInfo as ApiGitInfo;
use trill_app_server_protocol::InputItem as WireInputItem;
use trill_app_server_protocol::InterruptConversationParams;
use trill_app_server_protocol::JSONRPCErrorError;
use trill_app_server_protocol::ListConversationsParams;
use trill_app_server_protocol::ListConversationsResponse;
use trill_app_server_protocol::ListMcpServerStatusParams;
use trill_app_server_protocol::ListMcpServerStatusResponse;
use trill_app_server_protocol::LoginAccountParams;
use trill_app_server_protocol::LoginAccountResponse;
use trill_app_server_protocol::LoginApiKeyParams;
use trill_app_server_protocol::LoginApiKeyResponse;
use trill_app_server_protocol::LoginChatGptCompleteNotification;
use trill_app_server_protocol::LoginChatGptResponse;
use trill_app_server_protocol::LogoutAccountResponse;
use trill_app_server_protocol::LogoutChatGptResponse;
use trill_app_server_protocol::McpServerOauthLoginCompletedNotification;
use trill_app_server_protocol::McpServerOauthLoginParams;
use trill_app_server_protocol::McpServerOauthLoginResponse;
use trill_app_server_protocol::McpServerRefreshResponse;
use trill_app_server_protocol::McpServerStatus;
use trill_app_server_protocol::ModelListParams;
use trill_app_server_protocol::ModelListResponse;
use trill_app_server_protocol::NewConversationParams;
use trill_app_server_protocol::NewConversationResponse;
use trill_app_server_protocol::RemoveConversationListenerParams;
use trill_app_server_protocol::RemoveConversationSubscriptionResponse;
use trill_app_server_protocol::RequestId;
use trill_app_server_protocol::ResumeConversationParams;
use trill_app_server_protocol::ResumeConversationResponse;
use trill_app_server_protocol::ReviewDelivery as ApiReviewDelivery;
use trill_app_server_protocol::ReviewStartParams;
use trill_app_server_protocol::ReviewStartResponse;
use trill_app_server_protocol::ReviewTarget as ApiReviewTarget;
use trill_app_server_protocol::SandboxMode;
use trill_app_server_protocol::SendUserMessageParams;
use trill_app_server_protocol::SendUserMessageResponse;
use trill_app_server_protocol::SendUserTurnParams;
use trill_app_server_protocol::SendUserTurnResponse;
use trill_app_server_protocol::ServerNotification;
use trill_app_server_protocol::SessionConfiguredNotification;
use trill_app_server_protocol::SetDefaultModelParams;
use trill_app_server_protocol::SetDefaultModelResponse;
use trill_app_server_protocol::SkillsConfigWriteParams;
use trill_app_server_protocol::SkillsConfigWriteResponse;
use trill_app_server_protocol::SkillsListParams;
use trill_app_server_protocol::SkillsListResponse;
use trill_app_server_protocol::Thread;
use trill_app_server_protocol::ThreadArchiveParams;
use trill_app_server_protocol::ThreadArchiveResponse;
use trill_app_server_protocol::ThreadForkParams;
use trill_app_server_protocol::ThreadForkResponse;
use trill_app_server_protocol::ThreadItem;
use trill_app_server_protocol::ThreadListParams;
use trill_app_server_protocol::ThreadListResponse;
use trill_app_server_protocol::ThreadLoadedListParams;
use trill_app_server_protocol::ThreadLoadedListResponse;
use trill_app_server_protocol::ThreadReadParams;
use trill_app_server_protocol::ThreadReadResponse;
use trill_app_server_protocol::ThreadResumeParams;
use trill_app_server_protocol::ThreadResumeResponse;
use trill_app_server_protocol::ThreadRollbackParams;
use trill_app_server_protocol::ThreadSetNameParams;
use trill_app_server_protocol::ThreadSetNameResponse;
use trill_app_server_protocol::ThreadSortKey;
use trill_app_server_protocol::ThreadSourceKind;
use trill_app_server_protocol::ThreadStartParams;
use trill_app_server_protocol::ThreadStartResponse;
use trill_app_server_protocol::ThreadStartedNotification;
use trill_app_server_protocol::ThreadUnarchiveParams;
use trill_app_server_protocol::ThreadUnarchiveResponse;
use trill_app_server_protocol::Turn;
use trill_app_server_protocol::TurnError;
use trill_app_server_protocol::TurnInterruptParams;
use trill_app_server_protocol::TurnStartParams;
use trill_app_server_protocol::TurnStartResponse;
use trill_app_server_protocol::TurnStartedNotification;
use trill_app_server_protocol::TurnStatus;
use trill_app_server_protocol::UserInfoResponse;
use trill_app_server_protocol::UserInput as V2UserInput;
use trill_app_server_protocol::UserSavedConfig;
use trill_app_server_protocol::build_turns_from_event_msgs;
use trill_backend_client::Client as BackendClient;
use trill_chatgpt::connectors;
use trill_core::AuthManager;
use trill_core::CodexAuth;
use trill_core::TrillThread;
use trill_core::Cursor as RolloutCursor;
use trill_core::InitialHistory;
use trill_core::NewThread;
use trill_core::RolloutRecorder;
use trill_core::SessionMeta;
use trill_core::ThreadConfigSnapshot;
use trill_core::ThreadManager;
use trill_core::ThreadSortKey as CoreThreadSortKey;
use trill_core::auth::CLIENT_ID;
use trill_core::auth::login_with_api_key;
use trill_core::auth::login_with_chatgpt_auth_tokens;
use trill_core::config::Config;
use trill_core::config::ConfigOverrides;
use trill_core::config::ConfigService;
use trill_core::config::edit::ConfigEdit;
use trill_core::config::edit::ConfigEditsBuilder;
use trill_core::config::types::McpServerTransportConfig;
use trill_core::config_loader::CloudRequirementsLoader;
use trill_core::default_client::get_codex_user_agent;
use trill_core::error::CodexErr;
use trill_core::exec::ExecParams;
use trill_core::exec_env::create_env;
use trill_core::features::Feature;
use trill_core::find_archived_thread_path_by_id_str;
use trill_core::find_thread_path_by_id_str;
use trill_core::git_info::git_diff_to_remote;
use trill_core::mcp::collect_mcp_snapshot;
use trill_core::mcp::group_tools_by_server;
use trill_core::parse_cursor;
use trill_core::protocol::EventMsg;
use trill_core::protocol::Op;
use trill_core::protocol::ReviewDelivery as CoreReviewDelivery;
use trill_core::protocol::ReviewRequest;
use trill_core::protocol::ReviewTarget as CoreReviewTarget;
use trill_core::protocol::SessionConfiguredEvent;
use trill_core::read_head_for_summary;
use trill_core::read_session_meta_line;
use trill_core::rollout_date_parts;
use trill_core::sandboxing::SandboxPermissions;
use trill_core::state_db::get_state_db;
use trill_core::token_data::parse_id_token;
use trill_core::windows_sandbox::WindowsSandboxLevelExt;
use trill_feedback::CodexFeedback;
use trill_login::ServerOptions as LoginServerOptions;
use trill_login::ShutdownHandle;
use trill_login::run_login_server;
use trill_protocol::ThreadId;
use trill_protocol::config_types::ForcedLoginMethod;
use trill_protocol::config_types::Personality;
use trill_protocol::config_types::WindowsSandboxLevel;
use trill_protocol::dynamic_tools::DynamicToolSpec as CoreDynamicToolSpec;
use trill_protocol::items::TurnItem;
use trill_protocol::models::ResponseItem;
use trill_protocol::protocol::AgentStatus;
use trill_protocol::protocol::GitInfo as CoreGitInfo;
use trill_protocol::protocol::McpAuthStatus as CoreMcpAuthStatus;
use trill_protocol::protocol::McpServerRefreshConfig;
use trill_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use trill_protocol::protocol::RolloutItem;
use trill_protocol::protocol::SessionMetaLine;
use trill_protocol::protocol::USER_MESSAGE_BEGIN;
use trill_protocol::user_input::UserInput as CoreInputItem;
use trill_rmcp_client::perform_oauth_login_return_url;
use trill_utils_json_to_toml::json_to_toml;
...
pub(crate) struct CodexMessageProcessor {
    ...
    trill_linux_sandbox_exe: Option<PathBuf>,
    config: Arc<Config>,
...
impl CodexMessageProcessor {
    async fn load_thread(
        &self,
        thread_id: &str,
    ) -> Result<(ThreadId, Arc<TrillThread>), JSONRPCErrorError> {
    ...
    async fn load_latest_config(&self) -> Result<Config, JSONRPCErrorError> {
        trill_core::config::ConfigBuilder::default()
    ...
    fn review_request_from_target(
        ...
        let hint = trill_core::review_prompts::user_facing_hint(&core_target);
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = trill_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = trill_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn login_chatgpt_auth_tokens(
        ...
        if let Err(err) =
            login_with_chatgpt_auth_tokens(&self.config.trill_home, &id_token, &access_token)
        {
            let error = JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
    ...
    async fn get_user_saved_config(&self, request_id: RequestId) {
        let service = ConfigService::new_with_defaults(self.config.trill_home.clone());
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.trill_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: CommandExecParams) {
        ...
        let trill_linux_sandbox_exe = self.config.trill_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match trill_core::exec::process_exec_tool_call(
                exec_params,
                &effective_policy,
                sandbox_cwd.as_path(),
                &trill_linux_sandbox_exe,
    ...
    async fn process_new_conversation(
        ...
        let typesafe_overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            trill_linux_sandbox_exe: self.trill_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
    ...
    fn build_thread_config_overrides(
        ...
        cwd: Option<String>,
        approval_policy: Option<trill_app_server_protocol::AskForApproval>,
        ...
        ConfigOverrides {
            ...
            approval_policy: approval_policy
                .map(trill_app_server_protocol::AskForApproval::to_core),
    ...
    async fn thread_archive(&mut self, request_id: RequestId, params: ThreadArchiveParams) {
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.trill_home, &thread_id.to_string()).await
            {
                Ok(Some(p)) => p,
                Ok(None) => {
                    let error = JSONRPCErrorError {
    ...
    async fn thread_set_name(&self, request_id: RequestId, params: ThreadSetNameParams) {
        ...
        let Some(name) = trill_core::util::normalize_thread_name(&name) else {
    ...
    async fn thread_unarchive(&mut self, request_id: RequestId, params: ThreadUnarchiveParams) {
        ...
        let archived_folder = self
            .config
            .trill_home
            .join(trill_core::ARCHIVED_SESSIONS_SUBDIR);
        ...
        let result: Result<Thread, JSONRPCErrorError> = async {
            ...
            let sessions_folder = self.config.trill_home.join(trill_core::SESSIONS_SUBDIR);
    ...
    async fn thread_read(&mut self, request_id: RequestId, params: ThreadReadParams) {
        ...
        let rollout_path =
            match find_thread_path_by_id_str(&self.config.trill_home, &thread_uuid.to_string())
                .await
            {
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.trill_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ThreadId { conversation_id } => {
                match trill_core::find_thread_path_by_id_str(
                    &self.config.trill_home,
    ...
    async fn handle_resume_conversation(
        ...
        let thread_history = if let Some(path) = path {
            ...
            match find_thread_path_by_id_str(&self.config.trill_home, &conversation_id.to_string())
                .await
            {
                Ok(Some(found_path)) => {
    ...
    async fn archive_thread_common(
        ...
        let rollout_folder = self.config.trill_home.join(trill_core::SESSIONS_SUBDIR);
    ...
    async fn skills_list(&self, request_id: RequestId, params: SkillsListParams) {
        ...
        for cwd in cwds {
            ...
            data.push(trill_app_server_protocol::SkillsListEntry {
                cwd,
                skills,
                errors,
            });
    ...
    async fn skills_config_write(&self, request_id: RequestId, params: SkillsConfigWriteParams) {
        ...
        let result = ConfigEditsBuilder::new(&self.config.trill_home)
            .with_edits(edits)
            .apply()
            .await;
    ...
    async fn start_detached_review(
        ...
        let rollout_path =
            find_thread_path_by_id_str(&self.config.trill_home, &parent_thread_id.to_string())
                .await
                .map_err(|err| JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
...
fn skills_to_info(
    skills: &[trill_core::skills::SkillMetadata],
    disabled_paths: &std::collections::HashSet<PathBuf>,
) -> Vec<trill_app_server_protocol::SkillMetadata> {
    skills
        .iter()
        .map(|skill| {
            let enabled = !disabled_paths.contains(&skill.path);
            trill_app_server_protocol::SkillMetadata {
                name: skill.name.clone(),
                description: skill.description.clone(),
                short_description: skill.short_description.clone(),
                interface: skill.interface.clone().map(|interface| {
                    trill_app_server_protocol::SkillInterface {
                ...
                dependencies: skill.dependencies.clone().map(|dependencies| {
                    trill_app_server_protocol::SkillDependencies {
                        tools: dependencies
                            .tools
                            .into_iter()
                            .map(|tool| trill_app_server_protocol::SkillToolDependency {
                                r#type: tool.r#type,
                                value: tool.value,
                                description: tool.description,
...
fn errors_to_info(
    errors: &[trill_core::skills::SkillError],
) -> Vec<trill_app_server_protocol::SkillErrorInfo> {
    errors
        .iter()
        .map(|err| trill_app_server_protocol::SkillErrorInfo {
            path: err.path.clone(),
...
fn validate_dynamic_tools(
    ...
    for tool in tools {
        ...
        if let Err(err) = trill_core::parse_tool_input_schema(&tool.input_schema) {
            return Err(format!(
...
pub(crate) async fn read_event_msgs_from_rollout(
    path: &Path,
) -> std::io::Result<Vec<trill_protocol::protocol::EventMsg>> {
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match trill_core::parse_turn_item(&item) {
...
mod tests {
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use trill_protocol::protocol::RolloutItem;
        use trill_protocol::protocol::RolloutLine;
        use trill_protocol::protocol::SessionMetaLine;
        use std::fs;
