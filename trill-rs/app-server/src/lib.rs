...
use trill_app_server_protocol::TextPosition as AppTextPosition;
use trill_app_server_protocol::TextRange as AppTextRange;
use trill_core::ExecPolicyError;
use trill_core::check_execpolicy_for_warnings;
use trill_core::config_loader::ConfigLoadError;
use trill_core::config_loader::TextRange as CoreTextRange;
...
pub async fn run_main(
    ...
    let otel = trill_core::otel_init::build_provider(
        &config,
        env!("CARGO_PKG_VERSION"),
        Some("trill_app_server"),
