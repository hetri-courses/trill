...
use trill_app_server_protocol::ConfigRequirements;
use trill_app_server_protocol::ConfigRequirementsReadResponse;
use trill_app_server_protocol::ConfigValueWriteParams;
use trill_app_server_protocol::ConfigWriteErrorCode;
...
use trill_core::config::ConfigServiceError;
use trill_core::config_loader::CloudRequirementsLoader;
use trill_core::config_loader::ConfigRequirementsToml;
use trill_core::config_loader::LoaderOverrides;
use trill_core::config_loader::ResidencyRequirement as CoreResidencyRequirement;
use trill_core::config_loader::SandboxModeRequirement as CoreSandboxModeRequirement;
use serde_json::json;
...
fn map_requirements_toml_to_api(requirements: ConfigRequirementsToml) -> ConfigRequirements {
    ConfigRequirements {
        allowed_approval_policies: requirements.allowed_approval_policies.map(|policies| {
            policies
                .into_iter()
                .map(trill_app_server_protocol::AskForApproval::from)
                .collect()
        }),
...
) -> trill_app_server_protocol::ResidencyRequirement {
    match residency {
        CoreResidencyRequirement::Us => trill_app_server_protocol::ResidencyRequirement::Us,
    }
}
...
mod tests {
    ...
    fn map_requirements_toml_to_api_converts_core_enums() {
        ...
        assert_eq!(
            ...
            Some(vec![
                trill_app_server_protocol::AskForApproval::Never,
                trill_app_server_protocol::AskForApproval::OnRequest,
            ])
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Some(trill_app_server_protocol::ResidencyRequirement::Us),
        );
    }
}
