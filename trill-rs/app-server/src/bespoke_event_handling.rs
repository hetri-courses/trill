use crate::trill_message_processor::ApiVersion;
use crate::trill_message_processor::PendingInterrupts;
use crate::trill_message_processor::PendingRollbacks;
use crate::trill_message_processor::TurnSummary;
use crate::trill_message_processor::TurnSummaryStore;
use crate::trill_message_processor::read_event_msgs_from_rollout;
use crate::trill_message_processor::read_summary_from_rollout;
use crate::trill_message_processor::summary_to_thread;
use crate::error_code::INTERNAL_ERROR_CODE;
use crate::error_code::INVALID_REQUEST_ERROR_CODE;
use crate::outgoing_message::OutgoingMessageSender;
use trill_app_server_protocol::AccountRateLimitsUpdatedNotification;
use trill_app_server_protocol::AgentMessageDeltaNotification;
use trill_app_server_protocol::ApplyPatchApprovalParams;
use trill_app_server_protocol::ApplyPatchApprovalResponse;
use trill_app_server_protocol::CodexErrorInfo as V2CodexErrorInfo;
use trill_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use trill_app_server_protocol::CollabAgentTool;
use trill_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use trill_app_server_protocol::CommandAction as V2ParsedCommand;
use trill_app_server_protocol::CommandExecutionApprovalDecision;
use trill_app_server_protocol::CommandExecutionOutputDeltaNotification;
use trill_app_server_protocol::CommandExecutionRequestApprovalParams;
use trill_app_server_protocol::CommandExecutionRequestApprovalResponse;
use trill_app_server_protocol::CommandExecutionStatus;
use trill_app_server_protocol::ContextCompactedNotification;
use trill_app_server_protocol::DeprecationNoticeNotification;
use trill_app_server_protocol::DynamicToolCallParams;
use trill_app_server_protocol::ErrorNotification;
use trill_app_server_protocol::ExecCommandApprovalParams;
use trill_app_server_protocol::ExecCommandApprovalResponse;
use trill_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use trill_app_server_protocol::FileChangeApprovalDecision;
use trill_app_server_protocol::FileChangeOutputDeltaNotification;
use trill_app_server_protocol::FileChangeRequestApprovalParams;
use trill_app_server_protocol::FileChangeRequestApprovalResponse;
use trill_app_server_protocol::FileUpdateChange;
use trill_app_server_protocol::InterruptConversationResponse;
use trill_app_server_protocol::ItemCompletedNotification;
use trill_app_server_protocol::ItemStartedNotification;
use trill_app_server_protocol::JSONRPCErrorError;
use trill_app_server_protocol::McpToolCallError;
use trill_app_server_protocol::McpToolCallResult;
use trill_app_server_protocol::McpToolCallStatus;
use trill_app_server_protocol::PatchApplyStatus;
use trill_app_server_protocol::PatchChangeKind as V2PatchChangeKind;
use trill_app_server_protocol::PlanDeltaNotification;
use trill_app_server_protocol::RawResponseItemCompletedNotification;
use trill_app_server_protocol::ReasoningSummaryPartAddedNotification;
use trill_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use trill_app_server_protocol::ReasoningTextDeltaNotification;
use trill_app_server_protocol::ServerNotification;
use trill_app_server_protocol::ServerRequestPayload;
use trill_app_server_protocol::TerminalInteractionNotification;
use trill_app_server_protocol::ThreadItem;
use trill_app_server_protocol::ThreadNameUpdatedNotification;
use trill_app_server_protocol::ThreadRollbackResponse;
use trill_app_server_protocol::ThreadTokenUsage;
use trill_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use trill_app_server_protocol::ToolRequestUserInputOption;
use trill_app_server_protocol::ToolRequestUserInputParams;
use trill_app_server_protocol::ToolRequestUserInputQuestion;
use trill_app_server_protocol::ToolRequestUserInputResponse;
use trill_app_server_protocol::Turn;
use trill_app_server_protocol::TurnCompletedNotification;
use trill_app_server_protocol::TurnDiffUpdatedNotification;
use trill_app_server_protocol::TurnError;
use trill_app_server_protocol::TurnInterruptResponse;
use trill_app_server_protocol::TurnPlanStep;
use trill_app_server_protocol::TurnPlanUpdatedNotification;
...
use trill_core::parse_command::shlex_join;
use trill_core::protocol::ApplyPatchApprovalRequestEvent;
use trill_core::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use trill_core::protocol::Event;
use trill_core::protocol::EventMsg;
use trill_core::protocol::ExecApprovalRequestEvent;
use trill_core::protocol::ExecCommandEndEvent;
use trill_core::protocol::FileChange as CoreFileChange;
use trill_core::protocol::McpToolCallBeginEvent;
use trill_core::protocol::McpToolCallEndEvent;
use trill_core::protocol::Op;
use trill_core::protocol::ReviewDecision;
use trill_core::protocol::TokenCountEvent;
use trill_core::protocol::TurnDiffEvent;
use trill_core::review_format::format_review_findings_block;
use trill_core::review_prompts;
use trill_protocol::ThreadId;
use trill_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use trill_protocol::plan_tool::UpdatePlanArgs;
use trill_protocol::protocol::ReviewOutputEvent;
use trill_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use trill_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
    ...
    match msg {
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                trill_protocol::protocol::AgentStatus::Errored(_)
                | trill_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    trill_protocol::protocol::AgentStatus::Errored(_)
                        | trill_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let trill_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
...
async fn maybe_emit_raw_response_item_completed(
    ...
    conversation_id: ThreadId,
    turn_id: &str,
    item: trill_protocol::models::ResponseItem,
    outgoing: &OutgoingMessageSender,
) {
...
mod tests {
    ...
    use anyhow::anyhow;
    use anyhow::bail;
    use trill_app_server_protocol::TurnPlanStepStatus;
    use trill_core::protocol::CreditsSnapshot;
    use trill_core::protocol::McpInvocation;
    use trill_core::protocol::RateLimitSnapshot;
    use trill_core::protocol::RateLimitWindow;
    use trill_core::protocol::TokenUsage;
    use trill_core::protocol::TokenUsageInfo;
    use trill_protocol::plan_tool::PlanItemArg;
    use trill_protocol::plan_tool::StepStatus;
