...
use trill_core::spawn::CODEX_SANDBOX_NETWORK_DISABLED_ENV_VAR;
...
async fn test_codex_jsonrpc_conversation_flow() -> Result<()> {
    ...
    create_config_toml(&trill_home, &server.uri())?;
    ...
    let send_user_id = mcp
        .send_send_user_message_request(SendUserMessageParams {
            conversation_id,
            items: vec![trill_app_server_protocol::InputItem::Text {
                text: "text".to_string(),
...
fn create_config_toml(trill_home: &Path, server_uri: &str) -> std::io::Result<()> {
