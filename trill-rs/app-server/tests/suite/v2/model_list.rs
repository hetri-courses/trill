...
async fn list_models_pagination_works() -> Result<()> {
    ...
    assert_eq!(second_items[0].id, "gpt-5.1-trill-max");
    ...
    assert_eq!(third_items[0].id, "gpt-5.1-trill-mini");
