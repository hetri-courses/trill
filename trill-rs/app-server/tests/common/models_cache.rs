use chrono::DateTime;
use chrono::Utc;
use trill_core::models_manager::model_presets::all_model_presets;
...
pub fn write_models_cache(trill_home: &Path) -> std::io::Result<()> {
    ...
    write_models_cache_with_models(trill_home, models)
}
...
pub fn write_models_cache_with_models(
    ...
    let cache_path = trill_home.join("models_cache.json");
