...
use trill_core::compact::SUMMARIZATION_PROMPT;
use trill_core::compact::SUMMARY_PREFIX;
...
use trill_core::protocol::ItemStartedEvent;
...
async fn manual_compact_emits_api_and_local_token_usage_events() {
    ...
    let codex = builder.build(&server).await.unwrap().trill;
...
async fn auto_compact_runs_after_resume_when_token_usage_is_over_limit() {
    ...
    let compacted_history = vec![
        trill_protocol::models::ResponseItem::Message {
            id: None,
        ...
        trill_protocol::models::ResponseItem::Compaction {
    ...
    wait_for_event(&resumed.trill, |event| {
