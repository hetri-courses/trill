...
async fn list_models_returns_api_key_models() -> Result<()> {
    ...
    let config = load_default_config_for_test(&trill_home).await;
...
fn gpt_5_1_codex_max() -> ModelPreset {
    ModelPreset {
        id: "gpt-5.1-trill-max".to_string(),
        model: "gpt-5.1-trill-max".to_string(),
        display_name: "gpt-5.1-trill-max".to_string(),
...
fn gpt_5_1_codex_mini() -> ModelPreset {
    ModelPreset {
        id: "gpt-5.1-trill-mini".to_string(),
        model: "gpt-5.1-trill-mini".to_string(),
        display_name: "gpt-5.1-trill-mini".to_string(),
...
fn gpt_5_codex_mini() -> ModelPreset {
    ModelPreset {
        id: "gpt-5-trill-mini".to_string(),
        model: "gpt-5-trill-mini".to_string(),
        display_name: "gpt-5-trill-mini".to_string(),
        description: "Optimized for codex. Cheaper, faster, but less capable.".to_string(),
        default_reasoning_effort: ReasoningEffort::Medium,
        supported_reasoning_efforts: vec![
            effort(
