...
pub enum CodexErr {
    ...
    #[error("trill-linux-sandbox was required but not provided")]
...
impl CodexErr {
    ...
    pub fn to_trill_protocol_error(&self) -> CodexErrorInfo {
        match self {
    ...
    pub fn to_error_event(&self, message_prefix: Option<String>) -> ErrorEvent {
        ...
        ErrorEvent {
            message,
            codex_error_info: Some(self.to_trill_protocol_error()),
        }
    }
