...
pub use trill_protocol::config_types::AltScreenMode;
pub use trill_protocol::config_types::ModeKind;
pub use trill_protocol::config_types::Personality;
pub use trill_protocol::config_types::WebSearchMode;
...
pub struct Notice {
    ...
    /// Tracks whether the user has seen the gpt-5.1-trill-max migration prompt
    #[serde(rename = "hide_gpt-5.1-trill-max_migration_prompt")]
...
impl From<SandboxWorkspaceWrite> for trill_app_server_protocol::SandboxSettings {
