...
use trill_otel::config::OtelExporter;
use trill_otel::config::OtelHttpProtocol;
use trill_otel::config::OtelSettings;
use trill_otel::config::OtelTlsConfig as OtelTlsSettings;
use trill_otel::otel_provider::OtelProvider;
use std::error::Error;
...
/// Keeps events that originated from trill_otel module
pub fn codex_export_filter(meta: &tracing::Metadata<'_>) -> bool {
    meta.target().starts_with("trill_otel")
}
