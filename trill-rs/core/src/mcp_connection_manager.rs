...
//!
//! The [`McpConnectionManager`] owns one [`trill_rmcp_client::RmcpClient`] per
...
use trill_async_utils::CancelErr;
...
use trill_protocol::protocol::McpStartupCompleteEvent;
use trill_protocol::protocol::McpStartupFailure;
use trill_protocol::protocol::McpStartupStatus;
use trill_protocol::protocol::McpStartupUpdateEvent;
...
use trill_rmcp_client::RmcpClient;
use trill_rmcp_client::SendElicitation;
...
async fn start_server_task(
    ...
    let params = mcp_types::InitializeRequestParams {
        ...
        client_info: Implementation {
            name: "trill-mcp-client".to_owned(),
            version: env!("CARGO_PKG_VERSION").to_owned(),
            title: Some("Trill".into()),
...
mod tests {
    use super::*;
    use trill_protocol::protocol::McpAuthStatus;
