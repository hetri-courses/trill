use chrono::DateTime;
use chrono::Utc;
use trill_api::AuthProvider as ApiAuthProvider;
use trill_api::TransportError;
use trill_api::error::ApiError;
use trill_api::rate_limits::parse_rate_limit;
use http::HeaderMap;
...
const MODEL_CAP_MODEL_HEADER: &str = "x-trill-model-cap-model";
const MODEL_CAP_RESET_AFTER_HEADER: &str = "x-trill-model-cap-reset-after-seconds";
