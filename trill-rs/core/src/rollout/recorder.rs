...
use trill_protocol::protocol::ResumedHistory;
...
///
/// ```ignore
/// $ jq -C . ~/.trill/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.trill/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
impl RolloutRecorder {
    ...
    pub async fn list_threads(
        ...
        let state_db_ctx = state_db::open_if_present(trill_home, default_provider).await;
    ...
    pub async fn list_archived_threads(
        ...
        let root = trill_home.join(ARCHIVED_SESSIONS_SUBDIR);
...
fn create_log_file(config: &Config, conversation_id: ThreadId) -> std::io::Result<LogFileInfo> {
    // Resolve ~/.trill/sessions/YYYY/MM/DD and create it if missing.
    let timestamp = OffsetDateTime::now_local()
        .map_err(|e| IoError::other(format!("failed to get local time: {e}")))?;
    let mut dir = config.trill_home.clone();
