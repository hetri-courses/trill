...
pub use trill_client::CodexRequestBuilder;
...
/// See https://github.com/hetri-courses/trill/pull/3388/files for an example of what that would look like.
...
pub const DEFAULT_ORIGINATOR: &str = "trill_cli_rs";
pub const CODEX_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR: &str = "CODEX_INTERNAL_ORIGINATOR_OVERRIDE";
pub const RESIDENCY_HEADER_NAME: &str = "x-openai-internal-trill-residency";
...
mod tests {
    ...
    fn is_first_party_originator_matches_known_values() {
        ...
        assert_eq!(is_first_party_originator("trill_cli"), false);
    ...
    fn test_invalid_suffix_is_sanitized() {
        let prefix = "trill_cli_rs/0.0.0";
        let suffix = "bad\rsuffix";

        assert_eq!(
            sanitize_user_agent(format!("{prefix} ({suffix})"), prefix),
            "trill_cli_rs/0.0.0 (bad_suffix)"
        );
    }
