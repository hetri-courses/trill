...
pub(crate) struct AgentControl {
    ...
    /// `ThreadManagerState -> TrillThread -> Session -> SessionServices -> ThreadManagerState`.
...
impl AgentControl {
    ...
    pub(crate) async fn spawn_agent(
        ...
        prompt: String,
        session_source: Option<trill_protocol::protocol::SessionSource>,
...
mod tests {
    ...
    use trill_protocol::protocol::TurnCompleteEvent;
    ...
    impl AgentControlHarness {
        ...
        async fn start_thread(&self) -> (ThreadId, Arc<TrillThread>) {
            let new_thread = self
                .manager
