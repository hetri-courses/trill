...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match trill_tui::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = trill_tui::live_wrap::RowBuilder::new(20);
    ...
    trill_tui::insert_history::insert_history_lines(&mut term, lines)
