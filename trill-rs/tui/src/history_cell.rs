...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/hetri-courses/trill".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/hetri-courses/trill/releases/latest"
                .cyan()
                .underlined(),
        ];
...
pub fn new_approval_decision_cell(
    command: Vec<String>,
    decision: trill_core::protocol::ReviewDecision,
) -> Box<dyn HistoryCell> {
...
impl HistoryCell for SessionHeaderHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        // Title line rendered inside the box: ">_ Trill by Hetri (vX)"
        let title_spans: Vec<Span<'static>> = vec![
            Span::from(">_ ").dim(),
            Span::from("Trill by Hetri").bold(),
            Span::from(" ").dim(),
...
///
/// Manual testing tip:
/// - Run the rmcp stdio test server (`trill-rs/rmcp-client/src/bin/test_stdio_server.rs`) and
...
mod tests {
    ...
    use trill_core::config::types::McpServerConfig;
    use trill_core::config::types::McpServerTransportConfig;
    use trill_core::protocol::McpAuthStatus;
    use trill_protocol::models::WebSearchAction;
