...
use trill_protocol::request_user_input::RequestUserInputAnswer;
...
impl RequestUserInputOverlay {
    ...
    fn current_question(
        &self,
    ) -> Option<&trill_protocol::request_user_input::RequestUserInputQuestion> {
    ...
    fn options_len_for_question(
        question: &trill_protocol::request_user_input::RequestUserInputQuestion,
    ) -> usize {
...
mod tests {
    ...
    use crate::render::renderable::Renderable;
    use trill_protocol::request_user_input::RequestUserInputQuestion;
    use trill_protocol::request_user_input::RequestUserInputQuestionOption;
