...
pub enum UpdateAction {
    /// Update via `npm install -g @hetri-courses/trill@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @hetri-courses/trill@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@hetri-courses/trill"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@hetri-courses/trill"]),
