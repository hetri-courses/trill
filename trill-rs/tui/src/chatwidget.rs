...
use trill_core::config::ConstraintResult;
use trill_core::config::types::Notifications;
use trill_core::features::FEATURES;
use trill_core::features::Feature;
use trill_core::git_info::current_branch_name;
use trill_core::git_info::local_git_branches;
use trill_core::models_manager::manager::ModelsManager;
use trill_core::project_doc::DEFAULT_PROJECT_DOC_FILENAME;
use trill_core::protocol::AgentMessageDeltaEvent;
use trill_core::protocol::AgentMessageEvent;
use trill_core::protocol::AgentReasoningDeltaEvent;
use trill_core::protocol::AgentReasoningEvent;
use trill_core::protocol::AgentReasoningRawContentDeltaEvent;
use trill_core::protocol::AgentReasoningRawContentEvent;
use trill_core::protocol::ApplyPatchApprovalRequestEvent;
use trill_core::protocol::BackgroundEventEvent;
use trill_core::protocol::CodexErrorInfo;
use trill_core::protocol::CreditsSnapshot;
use trill_core::protocol::DeprecationNoticeEvent;
use trill_core::protocol::ErrorEvent;
use trill_core::protocol::Event;
use trill_core::protocol::EventMsg;
use trill_core::protocol::ExecApprovalRequestEvent;
use trill_core::protocol::ExecCommandBeginEvent;
use trill_core::protocol::ExecCommandEndEvent;
use trill_core::protocol::ExecCommandOutputDeltaEvent;
use trill_core::protocol::ExecCommandSource;
use trill_core::protocol::ExitedReviewModeEvent;
use trill_core::protocol::ListCustomPromptsResponseEvent;
use trill_core::protocol::ListSkillsResponseEvent;
use trill_core::protocol::McpListToolsResponseEvent;
use trill_core::protocol::McpStartupCompleteEvent;
use trill_core::protocol::McpStartupStatus;
use trill_core::protocol::McpStartupUpdateEvent;
use trill_core::protocol::McpToolCallBeginEvent;
use trill_core::protocol::McpToolCallEndEvent;
use trill_core::protocol::Op;
use trill_core::protocol::PatchApplyBeginEvent;
use trill_core::protocol::RateLimitSnapshot;
use trill_core::protocol::ReviewRequest;
use trill_core::protocol::ReviewTarget;
use trill_core::protocol::SkillMetadata as ProtocolSkillMetadata;
use trill_core::protocol::StreamErrorEvent;
use trill_core::protocol::TerminalInteractionEvent;
use trill_core::protocol::TokenUsage;
use trill_core::protocol::TokenUsageInfo;
use trill_core::protocol::TurnAbortReason;
use trill_core::protocol::TurnCompleteEvent;
use trill_core::protocol::TurnDiffEvent;
use trill_core::protocol::UndoCompletedEvent;
use trill_core::protocol::UndoStartedEvent;
use trill_core::protocol::UserMessageEvent;
use trill_core::protocol::ViewImageToolCallEvent;
use trill_core::protocol::WarningEvent;
use trill_core::protocol::WebSearchBeginEvent;
use trill_core::protocol::WebSearchEndEvent;
use trill_core::skills::model::SkillMetadata;
#[cfg(target_os = "windows")]
use trill_core::windows_sandbox::WindowsSandboxLevelExt;
use trill_otel::OtelManager;
use trill_protocol::ThreadId;
use trill_protocol::account::PlanType;
use trill_protocol::approvals::ElicitationRequestEvent;
use trill_protocol::config_types::CollaborationMode;
use trill_protocol::config_types::CollaborationModeMask;
use trill_protocol::config_types::ModeKind;
use trill_protocol::config_types::Personality;
use trill_protocol::config_types::Settings;
#[cfg(target_os = "windows")]
use trill_protocol::config_types::WindowsSandboxLevel;
use trill_protocol::models::local_image_label_text;
use trill_protocol::parse_command::ParsedCommand;
use trill_protocol::request_user_input::RequestUserInputEvent;
use trill_protocol::user_input::TextElement;
...
use chrono::Local;
use trill_common::approval_presets::ApprovalPreset;
use trill_common::approval_presets::builtin_approval_presets;
use trill_core::AuthManager;
use trill_core::CodexAuth;
use trill_core::ThreadManager;
use trill_core::protocol::AskForApproval;
use trill_core::protocol::SandboxPolicy;
use trill_file_search::FileMatch;
use trill_protocol::openai_models::ModelPreset;
use trill_protocol::openai_models::ReasoningEffort as ReasoningEffortConfig;
...
const NUDGE_MODEL_SLUG: &str = "gpt-5.1-trill-mini";
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) feedback: trill_feedback::CodexFeedback,
...
/// and by sending requests back to trill-core.
///
...
pub(crate) struct ChatWidget {
    ...
    trill_op_tx: UnboundedSender<Op>,
    ...
    /// Tracks whether trill-core currently considers an agent turn to be in progress.
    ///
    ...
    feedback: trill_feedback::CodexFeedback,
...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: trill_core::protocol::SessionConfiguredEvent) {
        self.bottom_pane
        ...
        // Ask trill-core to enumerate custom prompts for this session.
    ...
    fn on_thread_name_updated(&mut self, event: trill_core::protocol::ThreadNameUpdatedEvent) {
    ...
    fn on_patch_apply_end(&mut self, event: trill_core::protocol::PatchApplyEndEvent) {
        let ev2 = event.clone();
        self.defer_or_handle(
    ...
    fn on_get_history_entry_response(
        &mut self,
        event: trill_core::protocol::GetHistoryEntryResponseEvent,
    ) {
        let trill_core::protocol::GetHistoryEntryResponseEvent {
            offset,
            log_id,
            entry,
        } = event;
    ...
    pub(crate) fn handle_patch_apply_end_now(
        &mut self,
        event: trill_core::protocol::PatchApplyEndEvent,
    ) {
    ...
    pub(crate) fn new(common: ChatWidgetInit, thread_manager: Arc<ThreadManager>) -> Self {
        ...
        let trill_op_tx = spawn_agent(config.clone(), app_event_tx.clone(), thread_manager);
        ...
        widget.bottom_pane.set_windows_degraded_sandbox_active(
            trill_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED
                && matches!(
    ...
    pub(crate) fn new_from_existing(
        common: ChatWidgetInit,
        conversation: std::sync::Arc<trill_core::TrillThread>,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Logout => {
                if let Err(e) = trill_core::auth::logout(
            ...
            SlashCommand::TestApproval => {
                ...
                use trill_core::protocol::ApplyPatchApprovalRequestEvent;
                use trill_core::protocol::FileChange;
    ...
    fn dispatch_command_with_args(&mut self, cmd: SlashCommand, args: String) {
        ...
        match cmd {
            SlashCommand::Rename if !trimmed.is_empty() => {
                let Some(name) = trill_core::util::normalize_thread_name(trimmed) else {
    ...
    fn submit_user_message(&mut self, user_message: UserMessage) {
        ...
        self.trill_op_tx.send(op).unwrap_or_else(|e| {
    ...
    fn dispatch_event_msg(&mut self, id: Option<String>, msg: EventMsg, from_replay: bool) {
        ...
        match msg {
            ...
            EventMsg::ItemCompleted(event) => {
                if let trill_protocol::items::TurnItem::Plan(plan_item) = event.item {
    ...
    fn on_entered_review_mode(&mut self, review: ReviewRequest, from_replay: bool) {
        ...
        let hint = review
            .user_facing_hint
            .unwrap_or_else(|| trill_core::review_prompts::user_facing_hint(&review.target));
    ...
    fn is_auto_model(model: &str) -> bool {
        model.starts_with("trill-auto-")
    }

    fn auto_model_order(model: &str) -> usize {
        match model {
            "trill-auto-fast" => 0,
            "trill-auto-balanced" => 1,
            "trill-auto-thorough" => 2,
            _ => 3,
        }
    }
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let warn_for_model = preset.model.starts_with("gpt-5.1-codex")
            || preset.model.starts_with("gpt-5.1-trill-max")
    ...
    fn open_approval_mode_popup(&mut self, include_read_only: bool) {
        ...
        let show_elevate_sandbox_hint = trill_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED
        ...
        for preset in presets.into_iter() {
            ...
            let actions: Vec<SelectionAction> = if requires_confirmation {
                ...
                #[cfg(target_os = "windows")]
                {
                    ...
                    {
                        let preset_clone = preset.clone();
                        if trill_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED
                            && trill_core::windows_sandbox::sandbox_setup_is_complete(
                                self.config.trill_home.as_path(),
                            )
                        {
                            vec![Box::new(move |tx| {
    ...
    pub(crate) fn world_writable_warning_details(&self) -> Option<(Vec<String>, usize, bool)> {
        ...
        match trill_windows_sandbox::apply_world_writable_scan_and_denies(
            self.config.trill_home.as_path(),
            cwd.as_path(),
            &env_map,
            self.config.sandbox_policy.get(),
            Some(self.config.trill_home.as_path()),
        ) {
            Ok(_) => None,
    ...
    fn rename_confirmation_cell(name: &str, thread_id: Option<ThreadId>) -> PlainHistoryCell {
        let resume_cmd = trill_core::util::resume_command(Some(name), thread_id)
    ...
    pub(crate) fn submit_op(&mut self, op: Op) {
        ...
        if let Err(e) = self.trill_op_tx.send(op) {
    ...
    pub(crate) async fn show_review_commit_picker(&mut self, cwd: &Path) {
        let commits = trill_core::git_info::recent_commits(cwd, 100).await;
...
pub(crate) fn show_review_commit_picker_with_entries(
    chat: &mut ChatWidget,
    entries: Vec<trill_core::git_info::CommitLogEntry>,
) {
