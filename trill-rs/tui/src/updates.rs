...
use trill_core::default_client::create_client;
...
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/hetri-courses/trill/releases/latest";
...
fn version_filepath(config: &Config) -> PathBuf {
    config.trill_home.join(VERSION_FILENAME)
}
