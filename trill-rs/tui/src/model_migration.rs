    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.trill.com/models/gpt-5.1".to_string()),
                None,
                None,
                "gpt-5.1".to_string(),
    ...
    fn prompt_snapshot_gpt5_codex() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex",
                "gpt-5.1-trill-max",
                Some("https://www.trill.com/models/gpt-5.1-trill-max".to_string()),
                None,
                None,
                "gpt-5.1-trill-max".to_string(),
                Some("Codex-optimized flagship for deep and fast reasoning.".to_string()),
    ...
    fn prompt_snapshot_gpt5_codex_mini() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-trill-mini",
                "gpt-5.1-trill-mini",
                Some("https://www.trill.com/models/gpt-5.1-trill-mini".to_string()),
                None,
                None,
                "gpt-5.1-trill-mini".to_string(),
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.trill.com/models/gpt-new".to_string()),
                None,
                None,
                "gpt-new".to_string(),
