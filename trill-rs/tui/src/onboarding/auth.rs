...
use trill_core::auth::read_openai_api_key_from_env;
use trill_login::DeviceCode;
use trill_login::ServerOptions;
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            Line::from(vec![
                ...
                "\u{1b}]8;;https://github.com/hetri-courses/trill\u{7}Codex docs\u{1b}]8;;\u{7}".underlined(),
            ])
            .dim(),
            "".into(),
...
mod tests {
    ...
    fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let widget = AuthModeWidget {
            ...
            trill_home: trill_home_path.clone(),
