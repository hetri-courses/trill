...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [trill_core::protocol::PatchApplyBeginEvent]
    /// and [trill_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [trill_core::protocol::ExecCommandBeginEvent]
    /// and [trill_core::protocol::ExecCommandEndEvent].
    pub call_id: String,
