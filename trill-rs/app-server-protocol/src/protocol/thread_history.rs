...
use trill_protocol::protocol::AgentReasoningEvent;
use trill_protocol::protocol::AgentReasoningRawContentEvent;
...
impl ThreadHistoryBuilder {
    ...
    /// See `should_persist_event_msg` in `trill-rs/core/rollout/policy.rs`.
    ...
    fn handle_item_completed(&mut self, payload: &ItemCompletedEvent) {
        if let trill_protocol::items::TurnItem::Plan(plan) = &payload.item {
...
mod tests {
    use super::*;
    use trill_protocol::protocol::AgentMessageEvent;
    use trill_protocol::protocol::AgentReasoningEvent;
    use trill_protocol::protocol::AgentReasoningRawContentEvent;
    use trill_protocol::protocol::ThreadRolledBackEvent;
