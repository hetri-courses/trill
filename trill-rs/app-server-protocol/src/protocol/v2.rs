...
use trill_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
...
use trill_protocol::config_types::ReasoningSummary;
use trill_protocol::config_types::SandboxMode as CoreSandboxMode;
use trill_protocol::config_types::Verbosity;
use trill_protocol::config_types::WebSearchMode;
use trill_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use trill_protocol::items::TurnItem as CoreTurnItem;
use trill_protocol::models::ResponseItem;
use trill_protocol::openai_models::ReasoningEffort;
use trill_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use trill_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use trill_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use trill_protocol::protocol::AgentStatus as CoreAgentStatus;
use trill_protocol::protocol::AskForApproval as CoreAskForApproval;
use trill_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use trill_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use trill_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use trill_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use trill_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use trill_protocol::protocol::SessionSource as CoreSessionSource;
use trill_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use trill_protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use trill_protocol::protocol::SkillInterface as CoreSkillInterface;
use trill_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use trill_protocol::protocol::SkillScope as CoreSkillScope;
use trill_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use trill_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use trill_protocol::protocol::TokenUsage as CoreTokenUsage;
use trill_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
use trill_protocol::user_input::ByteRange as CoreByteRange;
use trill_protocol::user_input::TextElement as CoreTextElement;
use trill_protocol::user_input::UserInput as CoreUserInput;
use trill_utils_absolute_path::AbsolutePathBuf;
...
v2_enum_from_core!(
    pub enum ReviewDelivery from trill_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from trill_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// Path to a .trill/ folder within a project. There could be multiple of
...
impl SandboxPolicy {
    pub fn to_core(&self) -> trill_protocol::protocol::SandboxPolicy {
        match self {
            SandboxPolicy::DangerFullAccess => {
                trill_protocol::protocol::SandboxPolicy::DangerFullAccess
            }
            SandboxPolicy::ReadOnly => trill_protocol::protocol::SandboxPolicy::ReadOnly,
            SandboxPolicy::ExternalSandbox { network_access } => {
                trill_protocol::protocol::SandboxPolicy::ExternalSandbox {
            ...
            SandboxPolicy::WorkspaceWrite {
                ...
                exclude_slash_tmp,
            } => trill_protocol::protocol::SandboxPolicy::WorkspaceWrite {
...
impl From<trill_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: trill_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            trill_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            trill_protocol::protocol::SandboxPolicy::ReadOnly => SandboxPolicy::ReadOnly,
            trill_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
impl From<trill_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: trill_protocol::models::WebSearchAction) -> Self {
        match value {
            trill_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            trill_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            trill_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            trill_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
mod tests {
    use super::*;
    use trill_protocol::items::AgentMessageContent;
    use trill_protocol::items::AgentMessageItem;
    use trill_protocol::items::ReasoningItem;
    use trill_protocol::items::TurnItem;
    use trill_protocol::items::UserMessageItem;
    use trill_protocol::items::WebSearchItem;
    use trill_protocol::models::WebSearchAction as CoreWebSearchAction;
    use trill_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use trill_protocol::user_input::UserInput as CoreUserInput;
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.trill/skills/skill-creator/SKILL.md"),
                },
