...
`codex-otel` is the OpenTelemetry integration crate for Trill. It provides:
...
let settings = OtelSettings {
    ...
    service_name: "trill-cli".to_string(),
...
to Statsig using Trill-internal defaults.
