use trill_otel::metrics::MetricsClient;
use trill_otel::metrics::MetricsConfig;
use trill_otel::metrics::MetricsError;
use trill_otel::metrics::Result;
use opentelemetry_sdk::metrics::InMemoryMetricExporter;

fn build_in_memory_client() -> Result<MetricsClient> {
    let exporter = InMemoryMetricExporter::default();
    let config = MetricsConfig::in_memory("test", "trill-cli", env!("CARGO_PKG_VERSION"), exporter);
