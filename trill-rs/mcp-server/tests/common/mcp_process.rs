...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = trill_utils_cargo_bin::cargo_bin("trill-mcp-server")
            .context("should find binary for trill-mcp-server")?;
    ...
    pub async fn initialize(&mut self) -> anyhow::Result<()> {
        ...
        let originator = trill_core::default_client::originator().value;
    ...
    pub async fn send_trill_tool_call(
        &mut self,
        params: TrillToolCallParam,
    ) -> anyhow::Result<i64> {
