...
use trill_mcp_server::TrillToolCallParam;
use trill_mcp_server::ExecApprovalElicitRequestParams;
use trill_mcp_server::ExecApprovalResponse;
use trill_mcp_server::PatchApprovalElicitRequestParams;
use trill_mcp_server::PatchApprovalResponse;
...
async fn shell_command_approval_triggers_elicitation() -> anyhow::Result<()> {
    ...
    let codex_request_id = mcp_process
        .send_trill_tool_call(TrillToolCallParam {
...
async fn codex_tool_passes_base_instructions() -> anyhow::Result<()> {
    ...
    let mut mcp_process = McpProcess::new(trill_home.path()).await?;
