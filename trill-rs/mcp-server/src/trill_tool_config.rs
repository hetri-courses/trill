...
pub struct TrillToolCallParam {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub approval_policy: Option<TrillToolCallApprovalPolicy>,

    /// Sandbox mode: `read-only`, `workspace-write`, or `danger-full-access`.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sandbox: Option<TrillToolCallSandboxMode>,
...
#[serde(rename_all = "kebab-case")]
pub enum TrillToolCallApprovalPolicy {
    Untrusted,
    OnFailure,
    OnRequest,
    Never,
...
impl From<TrillToolCallApprovalPolicy> for AskForApproval {
    fn from(value: TrillToolCallApprovalPolicy) -> Self {
        match value {
            TrillToolCallApprovalPolicy::Untrusted => AskForApproval::UnlessTrusted,
            TrillToolCallApprovalPolicy::OnFailure => AskForApproval::OnFailure,
            TrillToolCallApprovalPolicy::OnRequest => AskForApproval::OnRequest,
            TrillToolCallApprovalPolicy::Never => AskForApproval::Never,
        }
    }
}
...
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq)]
#[serde(rename_all = "kebab-case")]
pub enum TrillToolCallSandboxMode {
    ReadOnly,
    WorkspaceWrite,
    DangerFullAccess,
}

impl From<TrillToolCallSandboxMode> for SandboxMode {
    fn from(value: TrillToolCallSandboxMode) -> Self {
        match value {
            TrillToolCallSandboxMode::ReadOnly => SandboxMode::ReadOnly,
            TrillToolCallSandboxMode::WorkspaceWrite => SandboxMode::WorkspaceWrite,
            TrillToolCallSandboxMode::DangerFullAccess => SandboxMode::DangerFullAccess,
        }
    }
}
...
pub(crate) fn create_tool_for_codex_tool_call_param() -> Tool {
    let schema = SchemaSettings::draft2019_09()
        ...
        .into_generator()
        .into_root_schema_for::<TrillToolCallParam>();
...
impl TrillToolCallParam {
    ...
    pub async fn into_config(
        ...
        // Build the `ConfigOverrides` recognized by trill-core.
...
pub struct TrillToolCallReplyParam {
...
/// Builds a `Tool` definition for the `trill-reply` tool-call.
pub(crate) fn create_tool_for_codex_tool_call_reply_param() -> Tool {
    let schema = SchemaSettings::draft2019_09()
        ...
        .into_generator()
        .into_root_schema_for::<TrillToolCallReplyParam>();
