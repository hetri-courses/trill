...
impl StateRuntime {
    ...
    ///
    /// This opens (and migrates) the SQLite database at `trill_home/state.sqlite`.
    pub async fn init(
        trill_home: PathBuf,
        default_provider: String,
        ...
        let state_path = trill_home.join(STATE_DB_FILENAME);
    ...
    pub fn trill_home(&self) -> &Path {
        self.trill_home.as_path()
    }
