...
pub use trill_core::connectors::AppInfo;
pub use trill_core::connectors::connector_display_label;
use trill_core::connectors::connector_install_url;
pub use trill_core::connectors::list_accessible_connectors_from_mcp_tools;
use trill_core::connectors::merge_connectors;
...
pub async fn list_all_connectors(config: &Config) -> anyhow::Result<Vec<AppInfo>> {
    ...
    init_chatgpt_token_from_auth(&config.trill_home, config.cli_auth_credentials_store_mode)
        .await?;
