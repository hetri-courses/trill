...
use trill_core::protocol::AgentStatus;
use trill_core::protocol::AskForApproval;
use trill_core::protocol::CollabAgentSpawnBeginEvent;
use trill_core::protocol::CollabAgentSpawnEndEvent;
use trill_core::protocol::CollabWaitingEndEvent;
...
use trill_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use trill_exec::exec_events::AgentMessageItem;
use trill_exec::exec_events::CollabAgentState;
use trill_exec::exec_events::CollabAgentStatus;
use trill_exec::exec_events::CollabTool;
use trill_exec::exec_events::CollabToolCallItem;
use trill_exec::exec_events::CollabToolCallStatus;
use trill_exec::exec_events::CommandExecutionItem;
use trill_exec::exec_events::CommandExecutionStatus;
use trill_exec::exec_events::ErrorItem;
use trill_exec::exec_events::ItemCompletedEvent;
use trill_exec::exec_events::ItemStartedEvent;
use trill_exec::exec_events::ItemUpdatedEvent;
use trill_exec::exec_events::McpToolCallItem;
use trill_exec::exec_events::McpToolCallItemError;
use trill_exec::exec_events::McpToolCallItemResult;
use trill_exec::exec_events::McpToolCallStatus;
use trill_exec::exec_events::PatchApplyStatus;
use trill_exec::exec_events::PatchChangeKind;
use trill_exec::exec_events::ReasoningItem;
use trill_exec::exec_events::ThreadErrorEvent;
use trill_exec::exec_events::ThreadEvent;
use trill_exec::exec_events::ThreadItem;
use trill_exec::exec_events::ThreadItemDetails;
use trill_exec::exec_events::ThreadStartedEvent;
use trill_exec::exec_events::TodoItem as ExecTodoItem;
use trill_exec::exec_events::TodoListItem as ExecTodoListItem;
use trill_exec::exec_events::TurnCompletedEvent;
use trill_exec::exec_events::TurnFailedEvent;
use trill_exec::exec_events::TurnStartedEvent;
use trill_exec::exec_events::Usage;
use trill_exec::exec_events::WebSearchItem;
use trill_protocol::ThreadId;
use trill_protocol::config_types::ModeKind;
use trill_protocol::models::WebSearchAction;
...
use trill_protocol::protocol::ExecCommandOutputDeltaEvent;
use trill_protocol::protocol::ExecOutputStream;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        trill_protocol::ThreadId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap();
    ...
    let ev = event(
        ...
        EventMsg::SessionConfigured(SessionConfiguredEvent {
            ...
            forked_from_id: None,
            thread_name: None,
            model: "trill-mini-latest".to_string(),
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TurnStarted(trill_core::protocol::TurnStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TurnComplete(trill_core::protocol::TurnCompleteEvent {
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(trill_core::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(trill_core::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = trill_core::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = trill_core::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(trill_core::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );
