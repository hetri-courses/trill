use trill_common::elapsed::format_duration;
use trill_common::elapsed::format_elapsed;
...
use trill_core::protocol::CollabAgentInteractionBeginEvent;
use trill_core::protocol::CollabAgentInteractionEndEvent;
use trill_core::protocol::CollabAgentSpawnBeginEvent;
use trill_core::protocol::CollabAgentSpawnEndEvent;
use trill_core::protocol::CollabCloseBeginEvent;
use trill_core::protocol::CollabCloseEndEvent;
use trill_core::protocol::CollabWaitingBeginEvent;
...
use trill_core::protocol::ItemCompletedEvent;
...
use trill_core::web_search::web_search_detail;
use trill_protocol::items::TurnItem;
use trill_protocol::num_format::format_with_separators;
...
use trill_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<trill_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "Trill by Hetri v{} (research preview)\n--------",
            VERSION
        );
        ...
        match msg {
            ...
            EventMsg::McpStartupUpdate(update) => {
                let status_text = match update.status {
                    trill_core::protocol::McpStartupStatus::Starting => "starting".to_string(),
                    trill_core::protocol::McpStartupStatus::Ready => "ready".to_string(),
                    trill_core::protocol::McpStartupStatus::Cancelled => "cancelled".to_string(),
                    trill_core::protocol::McpStartupStatus::Failed { ref error } => {
                        format!("failed: {error}")
                    }
                };
                ts_msg!(
...
fn format_receiver_list(ids: &[trill_protocol::ThreadId]) -> String {
    if ids.is_empty() {
