...
use trill_core::auth::logout;
use trill_core::config::Config;
use trill_login::ServerOptions;
use trill_login::run_device_code_login;
...
pub async fn run_login_status(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match CodexAuth::from_auth_storage(&config.trill_home, config.cli_auth_credentials_store_mode) {
...
pub async fn run_logout(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match logout(&config.trill_home, config.cli_auth_credentials_store_mode) {
        Ok(true) => {
