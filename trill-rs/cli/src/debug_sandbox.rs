...
use trill_core::landlock::spawn_command_under_linux_sandbox;
#[cfg(target_os = "macos")]
use trill_core::seatbelt::spawn_command_under_seatbelt;
use trill_core::spawn::StdioPolicy;
...
pub async fn run_command_under_seatbelt(
    ...
    _trill_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.trill_home.clone();
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let trill_linux_sandbox_exe = config
                .trill_linux_sandbox_exe
                .expect("trill-linux-sandbox executable not found");
