...
This document describes how exit, shutdown, and interruption work in the Rust TUI (`trill-rs/tui`).
It is intended for Trill developers and Trill itself when reasoning about future exit/shutdown
changes.
...
Trill has historically mixed "exit immediately" and "shutdown-first" across quit gestures, largely
