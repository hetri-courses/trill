// Launches the trill-exec-mcp-server binary bundled in this package.
...
async function main(): Promise<void> {
  ...
  const execveWrapperPath = path.join(targetRoot, "trill-execve-wrapper");
  const serverPath = path.join(targetRoot, "trill-exec-mcp-server");
